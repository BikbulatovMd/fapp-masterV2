...
public class AuthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //меняем цвет статус бара на нужный
    ...
    protected void onResume() {
        ...
        if (uri != null && uri.toString().startsWith(App.getRedirectUri())) {
            ...
            App.getNetWork().getAccessToken(App.getClientId(), App.getClientSecret(), code, new Callback<AccessToken>() {
                @Override
    ...
    private void getUserName() {
        App.getNetWork().getCurrentUser(new Callback<User>() {
            @Override
